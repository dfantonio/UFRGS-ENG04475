...
{
    int Ud = 0, Up = 0, y = 0, u = 0, erro = 0, Kp = 100, Kd = 5, referenciaTensao = 0;
    // referenciaTensao = (-0.003090909) * referencia + 1.41909091; // Equação retirada da curva de tensão x temperatura do diodo
